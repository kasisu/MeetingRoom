...
public class CancelCreateServlet extends SessionManagement {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			session.setAttribute("reservation", rvb);//取り消す予約
			session.setAttribute("room", rmb);//予約を取り消す会議室セット
		} catch (Exception e) {
		...
		String nextPage = "/cancelConfirm.jsp";//cancelConfirm予約確認画面にここでキャンセルはしない
